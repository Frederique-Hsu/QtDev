/*!
 *  \file       int_decorator_tests.cpp
 *  \brief
 *
 */


#include "int_decorator_tests.hpp"
...
namespace cm
{
    ...
    namespace data  // Tests
    {
        ...
        void IntDecoratorTests::constructor_givenParameters_setProperties()
        {
            Entity parentEntity;
        ...
        #if defined (USE_QSIGNAL_SPY)
            QCOMPARE(valueChangedSpy.count(), 1);
        #else
            QCOMPARE(isCalled, true);
        #endif
        }
