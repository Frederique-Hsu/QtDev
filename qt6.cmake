...
if (NOT EXISTS ${QT6_SOURCE_DIR}/.git)
    ...
    execute_process(
        COMMAND     ${GIT_EXECUTABLE} clone --recurse-submodules --depth=${GIT_CLONE_DEPTH} --branch=${GIT_TAG_OR_BRANCH} ${GIT_REPO_URL} ${QT6_SOURCE_DIR}
    ...
    if (NOT ${current_version_tag} STREQUAL ${GIT_TAG_OR_BRANCH})
        ...
        execute_process(
            COMMAND     ${GIT_EXECUTABLE} -C ${QT6_SOURCE_DIR} fetch --depth=${GIT_CLONE_DEPTH} origin ${GIT_TAG_OR_BRANCH}:${GIT_TAG_OR_BRANCH}
            COMMAND     ${GIT_EXECUTABLE} -C ${QT6_SOURCE_DIR} checkout ${GIT_TAG_OR_BRANCH}
